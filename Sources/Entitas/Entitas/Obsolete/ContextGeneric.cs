...
namespace Entitas
{
	public static class Context<C> where C : ContextAttribute
	{
		...
		{ return Instance.GetGroup(MatcherImpl<T1, T2, T3, T4, T5>.All()); }
		...
		{ return Instance.GetGroup(MatcherImpl<T1, T2, T3, T4, T5>.Any()); }
		...
		{ return Instance.GetGroup(MatcherImpl<T1, T2, T3, T4, T5, T6>.Any()); }
	}
}
